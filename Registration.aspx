        ...
        <table class="auto-style3">
            <tr>
                ...
                <td class="auto-style5">
                    <asp:Label ID="lblContactInformation" runat="server" style="font-weight: 700; text-align: center" Text="1. Contact Information"></asp:Label>
                </td>
                <td class="auto-style11">&nbsp;</td>
                <td class="auto-style41">
                    <asp:Label ID="lblCreateLogin" runat="server" style="font-weight: 700" Text="2. Create Login"></asp:Label>
                </td>
                <td class="auto-style38">
                    &nbsp;</td>
                <td rowspan="11">
                    <asp:Image ID="ImgQuote" runat="server" Height="593px" ImageUrl="~/Images/quotes.jpg" Width="414px" CssClass="auto-style40" />
                </td>
            </tr>
            <tr>
